            ...
            <tr>
                <td align="center">
                    <table width="595" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td height="30" align="center"><strong>Laporan Penjualan Saham</strong></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="14%"><strong>Persediaan</strong></td>
                                        <td width="11%"><strong>Kuantitas</strong></td>
                                        <td width="8%"><strong>Menilai</strong></td>
                                        <td width="11%"><strong>Pembukaan<br>
                                                Stock</strong></td>
                                        <td width="11%"><strong>Penutupan<br>
                                                Stock</strong></td>
