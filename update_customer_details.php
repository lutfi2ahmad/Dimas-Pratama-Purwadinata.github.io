...
<head>
    <meta charset="utf-8">
    <title>Pure Nature Shop - Tambah Pelanggan</title>
                        ...
                        <table class="form" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <form name="form1" method="post" id="form1" action="">
                                ...
                                <tr>
                                    <td><b>Address:</b></td>
                                    <td>
                                        <textarea name="address" cols="15" class="round full-width-textarea">
						<?php echo $line->customer_address; ?>
					</textarea>
                                   </td>
                                    <td><b>Contact</b><b>-2</b></td>
                                    <td><input name="contact2" type="text" id="sellingrate" maxlength="20" class="round default-width-input" onkeypress="return numbersonly(event)" value="<?php echo $line->customer_contact2; ?>"/></td>
                                </tr>
                                <tr>
                                    <td>
                                        &nbsp;
