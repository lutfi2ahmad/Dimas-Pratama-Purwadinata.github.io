...
<head>
    <meta charset="utf-8">
    <title>Pure Nature Shop - Update Pembayaran</title>
                        ...
                        <table class="form" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <form name="form1" method="post" id="form1" action="">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Sales ID</td>
                                    <td><input name="stock_id" type="text" readonly="readonly" 
                                               readonly="readonly" id="stockid" maxlength="200" class="round default-width-input" 
